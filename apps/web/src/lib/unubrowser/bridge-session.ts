...
export async function publishUnubrowserBridgeSession(
  ...
  return readJsonResponse<BridgeSessionPublishResponse>(
    response,
    "unubrowser_bridge_publish_failed",
  );
}

export async function clearUnubrowserBridgeSession(
  ...
  return readJsonResponse<BridgeSessionClearResponse>(
    response,
    "unubrowser_bridge_clear_failed",
  );
}
