...
`UNUVAULT_IOS_PAIRING_RECEIPT paired` in the iPhone console. The 2026-07-07
hardware run recorded physical receipt harness proof; it still does not claim
camera QR scanning or local decrypt/import.
