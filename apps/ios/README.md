...
`publicKeyFingerprint`, and parse the Mac handoff response envelope while
rejecting invalid, expired, or target-mismatched responses. It does not claim
camera QR scanning, LAN transport, local decrypt/import, or physical iPhone
receipt yet.
