...
export const DEV_SECRETS_PROVIDER_USAGE = [
  ...
  "  bash scripts/secrets/provider.sh read --app unuidentity --env staging",
  "  bash scripts/secrets/provider.sh read --app unuidentity --env production",
  "  bash scripts/secrets/provider.sh verify --app unuidentity --env local",
  "  bash scripts/secrets/provider.sh import --app unuidentity --env local --from /absolute/path/to/phase1.env",
  "  bash scripts/secrets/provider.sh import --app unuidentity --env production --from /absolute/path/to/production.env",
